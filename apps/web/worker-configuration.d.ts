/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4e5b774694c17e8a9be2eeadccd62beb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			Cloudflare.Env,
			'PUBLIC_SITE_URL' | 'PUBLIC_ENVIRONMENT' | 'PUBLIC_GTM_ID' | 'PUBLIC_GA_MEASUREMENT_ID'
		>
	> {}
}
