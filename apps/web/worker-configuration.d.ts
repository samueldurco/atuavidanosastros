/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 254a1c6a76cc8292d8aa8e42dd245df3)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_als
interface __BaseEnv_Env {
	PUBLIC_SITE_URL: 'https://atuavidanosastros.com.br';
	PUBLIC_SUPABASE_URL: 'https://irgnhvouvzyoqfmltrna.supabase.co';
	PUBLIC_ENVIRONMENT: 'production';
	PUBLIC_GTM_ID: 'GTM-T576R9MR';
	PUBLIC_GA_MEASUREMENT_ID: 'G-XKBGJ113Z5';
	AUTOMATIC_SPEND_CAP_BRL: '0';
	FEATURE_AI: 'false';
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			...
			| 'AUTOMATIC_SPEND_CAP_BRL'
			| 'FEATURE_AI'
			| 'FEATURE_HOTMART_LIVE'
			| 'FEATURE_MAGIC_LINK'
			| 'FEATURE_PHYSICAL_CHECKOUT'
		>
	> {}
}
